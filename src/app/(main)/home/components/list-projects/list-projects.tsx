...
import { FaExternalLinkAlt, FaGithub, FaList } from "react-icons/fa";
    ...
    return (
        <div className="space-y-8">
            ...
            >
                <Link
                    href="/projects"
                    className="px-6 py-3 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white rounded-md font-medium shadow-md hover:scale-105 transition-all duration-300"
                >
                    See All Projects
                </Link>
            </motion.div>
