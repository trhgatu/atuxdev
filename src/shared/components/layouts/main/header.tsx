              ...
              <div className="flex flex-col h-full dark:bg-[#202020] bg-white">
                ...
                <div className="flex-1 py-8 px-6 overflow-y-auto dark:bg-[#202020] bg-white">
                  <motion.div className="space-y-1">
                    {["projects", "journey", "blog", "skills", "resume"].map((section, index) => (
                      <motion.button
                        key={section}
                        variants={itemVariants}
                        custom={index}
                        ...
                        whileTap={{ scale: 0.98 }}
                        onClick={() => scrollToSection(section)}
                        className="w-full text-left py-3 px-4 rounded-lg hover:bg-accent transition-colors duration-200 flex items-center"
                      >
